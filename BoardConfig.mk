...
##############################################################
# Source: device/intel/mixins/groups/igeneric/default/BoardConfig.mk
##############################################################
...
##############################################################
# Source: device/intel/mixins/groups/graphics/igeneric/BoardConfig.mk
##############################################################
...
BOARD_SEPOLICY_DIRS += $(INTEL_PATH_SEPOLICY)/graphics/igeneric
...
##############################################################
# Source: device/intel/mixins/groups/media/igeneric/BoardConfig.mk
##############################################################
...
##############################################################
# Source: device/intel/mixins/groups/kernel/igeneric/BoardConfig.mk
##############################################################
...
BOARD_SEPOLICY_DIRS += $(INTEL_PATH_SEPOLICY)/bluetooth/common \
                       $(INTEL_PATH_SEPOLICY)/bluetooth/intel
...
##############################################################
# Source: device/intel/mixins/groups/boot-arch/igeneric/BoardConfig.mk
##############################################################
#TARGET_NO_RECOVERY ?= false

TARGET_BOARD_PLATFORM := igeneric
...
BOARD_SEPOLICY_DIRS += $(INTEL_PATH_SEPOLICY)/boot-arch/igeneric/$(TARGET_PRODUCT)
...
TARGET_RELEASETOOLS_EXTENSIONS ?= $(INTEL_PATH_COMMON)/recovery
...
##############################################################
# Source: device/intel/mixins/groups/audio/igeneric/BoardConfig.mk
##############################################################
...
BOARD_SEPOLICY_DIRS += $(INTEL_PATH_SEPOLICY)/audio/igeneric
##############################################################
...
DEVICE_PACKAGE_OVERLAYS += $(INTEL_PATH_COMMON)/wlan/overlay-wifi-tethering
...
TRUSTY_ENV_VAR += TRUSTY_REF_TARGET=igeneric_64
