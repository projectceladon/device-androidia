...
##############################################################
# Source: device/intel/mixins/groups/igeneric/default/AndroidBoard.mk
##############################################################
droid: flashfiles
...
##############################################################
# Source: device/intel/mixins/groups/kernel/igeneric/AndroidBoard.mk
##############################################################
ifneq ($(TARGET_PREBUILT_KERNEL),)
$(error TARGET_PREBUILT_KERNEL defined but AndroidIA kernels build from source)
endif

TARGET_KERNEL_SRC ?= kernel/igeneric

TARGET_KERNEL_ARCH := x86_64
TARGET_KERNEL_CONFIG ?= kernel_64_defconfig

KERNEL_CONFIG_DIR := $(INTEL_PATH_DEVICE)/kernel_config
...
KERNEL_CONFIG_FILE := $(INTEL_PATH_DEVICE)/kernel_config/$(TARGET_KERNEL_CONFIG)
...
##############################################################
# Source: device/intel/mixins/groups/boot-arch/igeneric/AndroidBoard.mk
##############################################################
...
BOOTLOADER_FROM_ZIP = $(INTEL_PATH_BUILD)/bootloader_from_zip
...
##############################################################
# Source: device/intel/mixins/groups/audio/igeneric/AndroidBoard.mk
##############################################################
...
$(TOS_IMAGE_TARGET):
	...
	$(hide) (cd $(TOPDIR)$(INTEL_PATH_VENDOR)/fw/evmm/$(INTERNAL_PLATFORM) && $(TRUSTY_ENV_VAR) $(LOCAL_MAKE))
