...
codecs: configurable(hw_ve_h265=true, hw_vd_vp9=true, hw_vd_mp2=true, hw_vd_vc1=false, sw_omx_video=true, platform=tgl, profile_file=media_profiles_1080p.xml, gpu=gen12)
codec2: true
usb: host
