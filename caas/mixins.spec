...
telephony: false
load_modules: true
gptbuild: true(size=8500M,generate_craff=false,compress_gptimage=true)
dynamic-partitions: true(super_img_in_flashzip=true,super_partition_size=7000,virtual_ab=true,virtual_ab_compression=true)
dbc: true
atrace: true
