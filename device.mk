...
##############################################################
# Source: device/intel/mixins/groups/igeneric/default/product.mk
##############################################################
#Product Characteristics
PRODUCT_DIR := $(dir $(lastword $(filter-out device/common/%,$(filter device/%,$(ALL_PRODUCTS)))))

INTEL_PATH_DEVICE := device/intel/igeneric
...
PRODUCT_COPY_FILES += \
    $(INTEL_PATH_DEVICE)/manifest.xml:vendor/manifest.xml
##############################################################
# Source: device/intel/mixins/groups/graphics/igeneric/product.mk
##############################################################
# Mesa
PRODUCT_PACKAGES += \
    libGLES_mesa \
...
PRODUCT_PROPERTY_OVERRIDES += \
   ...
   ro.hardware.hwcomposer=igeneric

# Mini gbm
PRODUCT_PROPERTY_OVERRIDES += \
    ro.hardware.gralloc=igeneric
...
##############################################################
# Source: device/intel/mixins/groups/media/igeneric/product.mk
##############################################################
# libva, vaapi
PRODUCT_PACKAGES += \
    libva \
...
##############################################################
# Source: device/intel/mixins/groups/kernel/igeneric/product.mk
##############################################################
...
##############################################################
# Source: device/intel/mixins/groups/boot-arch/igeneric/product.mk
##############################################################
...
##############################################################
# Source: device/intel/mixins/groups/audio/igeneric/product.mk
##############################################################
# Tinyalsa
PRODUCT_PACKAGES_DEBUG += \
         tinymix \
...
PRODUCT_COPY_FILES += \
        $(INTEL_PATH_COMMON)/wlan/wpa_supplicant-common.conf:system/etc/wifi/wpa_supplicant.conf \
        $(INTEL_PATH_COMMON)/wlan/iwlwifi/wpa_supplicant_overlay.conf:system/etc/wifi/wpa_supplicant_overlay.conf \
...
##############################################################
PRODUCT_COPY_FILES += $(INTEL_PATH_COMMON)/rfkill/rfkill-init.sh:system/bin/rfkill-init.sh
##############################################################
...
PRODUCT_PACKAGES += lights.igeneric \
