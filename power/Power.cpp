...
Return<void> Power::setInteractive(bool interactive)  {
    ALOGE("POWERHALV1.2 - setInteractive");
...
Return<void> Power::getPlatformLowPowerStats(getPlatformLowPowerStats_cb _hidl_cb)  {
    ALOGE("POWERHALV1.2 - getPlatformLowPowerStats");
...
Return<void> Power::getSubsystemLowPowerStats(getSubsystemLowPowerStats_cb _hidl_cb) {
    ALOGE("POWERHALV1.2 - getSubsystemLowPowerStats");
...
Return<void> Power::powerHintAsync(::android::hardware::power::V1_0::PowerHint hint, int32_t data) {
    ALOGE("POWERHALV1.2 - powerHintAsync");
